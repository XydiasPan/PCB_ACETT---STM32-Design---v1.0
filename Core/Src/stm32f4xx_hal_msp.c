...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA2     ------> ADC1_IN2
    */
    GPIO_InitStruct.Pin = ADC_A2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_A2_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PA1     ------> ADC2_IN1
    */
    GPIO_InitStruct.Pin = ADC__Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC__GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA2     ------> ADC1_IN2
    */
    HAL_GPIO_DeInit(ADC_A2_GPIO_Port, ADC_A2_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA1     ------> ADC2_IN1
    */
    HAL_GPIO_DeInit(ADC__GPIO_Port, ADC__Pin);
